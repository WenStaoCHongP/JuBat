...
- Files created/modified:
  - `docs/planning-with-files/损伤异常/task_plan.md`
  - `docs/planning-with-files/损伤异常/findings.md`
  - `docs/planning-with-files/损伤异常/progress.md`
...
- Files created/modified:
  - `docs/planning-with-files/损伤异常/task_plan.md`
  - `docs/planning-with-files/损伤异常/findings.md`
  - `docs/planning-with-files/损伤异常/tmp_czm_probe.jl`
...
- Files created/modified:
  - `docs/planning-with-files/损伤异常/first_czm_step_probe.jl`
...
- Files created/modified:
  - `docs/planning-with-files/损伤异常/solve_tol_3e-4_probe.jl`
...
- Files created/modified:
  - `docs/planning-with-files/损伤异常/tangent_branch_probe.jl`
...
- Files created/modified:
  - `docs/planning-with-files/损伤异常/unit_scale_probe.jl`
...
- Files created/modified:
  - `docs/planning-with-files/损伤异常/load_substep_compare.jl`
...
- Files created/modified:
  - `docs/planning-with-files/损伤异常/tangent_continuity_probe.jl`
