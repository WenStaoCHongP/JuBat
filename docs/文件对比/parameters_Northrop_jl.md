# parameters/Northrop.jl

## 文件状态: 修改 (M)

## main分支
- 行数: 132
- 内容: Northrop 电池参数集（来自 LIONSIMBA）
- 结构:
  - PE (正极) 参数: 电化学 + 力学
  - NE (负极) 参数: 电化学 + 力学
...
与 LGM50.jl 和 Enertech.jl 完全相同的适配性变更模式。Northrop 不是 Jellyroll 电池，不包含 Jellyroll 特有参数，CZM 参数为零值默认。
