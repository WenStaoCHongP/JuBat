...
- **日期**：2026-08-20
- **评审修订**：v1.1（2026-08-20，理论正确性验证 + FEM 可行性评审，新增 D8–D11，见 §10.1）；**v1.2**（2026-08-20，第二轮全库独立复核，更正 v1.1 两处错误结论并新增 D12–D15，见 §10.2）；**v1.3**（2026-08-21，实现计划评审后：Batch 1 基线门禁工具替换为 `verify_czm_standalone.jl`，见 §10.3）
