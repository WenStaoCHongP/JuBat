...
- [x] 代码独有用 `--`（双连字符 ASCII）+ `【缺失】`（见 (6.x37)-(6.x44)）
- [x] 卷末有 `## 编号总表` 和 `## 草稿`
...
| 等级 | 计数 | 典型代表 |
|---|---|---|
| ✅ | 41 | 双线性律 (6.1)/(6.3)/(6.4)、单元矩阵 (6.12)-(6.16)、热化学载荷 (6.18)-(6.19)、重设计 v2 (6.21)-(6.22)、粘性离散 (14.2)-(14.6)、切线一致性 (14.8) |
| 🟡 | 9 | md 06 (6.2) 用 D 代码用 D_visc、md §8 行号过时、md (6.20) 全栈加权 vs 代码单层、md (6.x17) 调用路径不符、md (6.x18) @warn vs @assert、md (6.x23) 输出层未还原、md (6.x26) 阈值不一致、md (14.1) Abaqus ODE vs 显式离散、md (14.x4) 行号过时 |
| ⚠️ | 2 | md 06 vs md 14 表述不一致 (14.x3)、md 与代码注释 τ_v 数量级差 6 个数量级 (14.x5) |
| ❌ | 0 | — |
| — | 9 | md §1 概念陈述、md §4.4 性能表、md §5.2 伪代码、md (6.27) SOH 归属其他卷、md (6.15)/(6.16) 函数缺失、md (6.30) 函数名不符、md 14 §3-5 概念、md 14 §7 总结 |
