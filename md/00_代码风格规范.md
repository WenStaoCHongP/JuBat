...
```julia
export Assemble, ElectrodeDiffusion, ElectrolyteDiffusion, Postprocessing
export SetCase, SetMesh, ChooseCell
export Mesh1D, GetGS, LagrangeBasis, GSweight, ShapeFunction1D
export NormaliseParam, StandardVariables
...
| `src/SetMesh.jl` | 网格结构体、高斯积分 |
| `src/Solve.jl` | 时间积分、模型调用 |
| `src/Variables.jl` | 变量字典管理 |
