...
function ThermalDistributed2D(case::Case, variables::Dict{String,Union{Array{Float64},Float64}})
    ...
    # 装配质量矩阵
    MT = _assemble_mass_matrix(case, variables, ne, Vi, Vj, Ni, wJ, ρc_ref, L_th, nnode)
...
function _assemble_mass_matrix(case, variables, ne, Vi, Vj, Ni, wJ, ρc_ref, L_th, nnode)
