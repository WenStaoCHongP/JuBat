...
cell.Rout = 0.021/2
cell.Rin = 1.92e-3
cell.length = 1.47   # Using outer diameter proxy (not used by scaling below)
cell.width = 7e-2
cell.wrapper = 0
cell.I1C = 5
cell.no_layers = 1
...
cohesive.δ_0_n = 15e-9         # 损伤起始分离位移 [m] (15 nm)
cohesive.δ_c_n = 100e-9        # 临界分离位移 [m] (75 nm)
...
cohesive.δ_0_t = 45e-9         # 损伤起始切向位移 [m] (45 nm)
