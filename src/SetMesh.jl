...
function CzmSubmesh(mesh::Mesh, material_type::Vector{Symbol}, winding_turn::Vector{Int},
                    thermal_elem_map::Vector{Int}, phi_pairs::Vector{Tuple{Int,Int}})
    return CzmSubmesh(mesh, material_type, winding_turn, thermal_elem_map,
                      phi_pairs, mesh, collect(1:mesh.nlen))
end
